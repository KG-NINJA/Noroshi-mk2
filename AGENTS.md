...
Repository: `KG-NINJA/Noroshi-mk2`.
...
Existing CI/deployment definitions: `.github/workflows/noroshi.yml`. Inspect applicable triggers before push/merge. A workflow filename alone does not prove a deploy target or successful deployment.
